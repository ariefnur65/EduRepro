...
public class fragmentKuis2 extends Fragment implements View.OnClickListener {
    View fragmentLayout;
    Animation myAnim;
    View layout;
    View mainlayout;
    ...
    public fragmentKuis2(){}
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        fragmentLayout = inflater.inflate(R.layout.activity_fragment_kuis2,container,false);
        ...
        buttonk.add(btnC);
        buttonk.add(btnD);
        soalString = getResources().getStringArray(R.array.soal2);
        pilihan = getResources().getStringArray(R.array.pilihan2);
        jumlahpilhan = getResources().getIntArray(R.array.jumlahpilihan2);
        jawabankuis = getResources().getStringArray(R.array.penjelasanjawaban2);
        jawabanPiliihanKuis = getResources().getIntArray(R.array.jawabankuis2);
...
//        pw.showAtLocation(mainlayout, Gravity.CENTER, 0, 0);
        ...
        soalDikerjakan = userData.getInt(getString(R.string.QUIZ_AKU_SOAL2),-1);
            ...
            for(int i = 0 ; i < jumlahpilhan[nomor];i++){
                ...
                switch (jumlahpilhan[nomor]){
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        for (int t =0; i < buttonk.size();i++)
                        {
                            buttonk.get(i).setEnabled(true);
                            buttonk.get(i).setAlpha(1f);
...
//        Jika jawaban benar maka Button akan berganti warna menjadi emas
        ...
        if(jawaban == jawabanBenar){
            ...
            pw.showAtLocation(fragmentLayout.findViewById(R.id.kuis2), Gravity.CENTER, 0, 0);
...
//        Jika salah maka yang benar di ganti warna, dan yang dipilih berganti warna menjadi abu2
    ...
    public void updateNilai(){
        ...
        editor.putInt(getString(R.string.QUIZ_AKU_SOAL2), soalDikerjakan);
