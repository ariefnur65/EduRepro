...
public class fragmentKuis3 extends Fragment implements View.OnClickListener {
    View fragmentLayout;
    Animation myAnim;
    View layout;
    View mainlayout;
    ...
    public fragmentKuis3(){}
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        fragmentLayout = inflater.inflate(R.layout.activity_fragment_kuis3,container,false);
        ...
        buttonk.add(btnC);
        buttonk.add(btnD);
        soalString = getResources().getStringArray(R.array.soal3);
        pilihan = getResources().getStringArray(R.array.pilihan3);
        jumlahpilhan = getResources().getIntArray(R.array.jumlahpilihan3);
        jawabankuis = getResources().getStringArray(R.array.penjelasanjawaban3);
        jawabanPiliihanKuis = getResources().getIntArray(R.array.jawabankuis3);
...
//        pw.showAtLocation(mainlayout, Gravity.CENTER, 0, 0);
        ...
        soalDikerjakan = userData.getInt(getString(R.string.QUIZ_AKU_SOAL3),-1);
...
//        Jika jawaban benar maka Button akan berganti warna menjadi emas
        ...
        if(jawaban == jawabanBenar){
            ...
            playKalah();
            pw.showAtLocation(fragmentLayout.findViewById(R.id.kuis3), Gravity.CENTER, 0, 0);
...
//        Jika salah maka yang benar di ganti warna, dan yang dipilih berganti warna menjadi abu2
    ...
    public void updateNilai(){
        ...
        editor.putInt(getString(R.string.QUIZ_AKU_SOAL3), soalDikerjakan);
