...
public class fragmentKuis4 extends Fragment implements View.OnClickListener {
    View fragmentLayout;
    Animation myAnim;
    View layout;
    View mainlayout;
    ...
    public fragmentKuis4(){}
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        fragmentLayout = inflater.inflate(R.layout.activity_fragment_kuis4,container,false);
        ...
        buttonk.add(btnC);
        buttonk.add(btnD);
        soalString = getResources().getStringArray(R.array.soal4);
        pilihan = getResources().getStringArray(R.array.pilihan4);
        jumlahpilhan = getResources().getIntArray(R.array.jumlahpilihan4);
        jawabankuis = getResources().getStringArray(R.array.penjelasanjawaban4);
        jawabanPiliihanKuis = getResources().getIntArray(R.array.jawabankuis4);
        ...
        restNumb = 2;//Ganti ini sesuai jumlah soal
        currentNumb =0;
...
//        pw.showAtLocation(mainlayout, Gravity.CENTER, 0, 0);
        ...
        soalDikerjakan = userData.getInt(getString(R.string.QUIZ_AKU_SOAL4),-1);
...
//        Jika jawaban benar maka Button akan berganti warna menjadi emas
        ...
        if(jawaban == jawabanBenar){
            ...
            pw.showAtLocation(fragmentLayout.findViewById(R.id.kuis4), Gravity.CENTER, 0, 0);
...
//        Jika salah maka yang benar di ganti warna, dan yang dipilih berganti warna menjadi abu2
    ...
    public void updateNilai(){
        ...
        editor.putInt(getString(R.string.QUIZ_AKU_SOAL4), soalDikerjakan);
