...
public class fragmentKuis7 extends Fragment implements View.OnClickListener {
    View fragmentLayout;
    Animation myAnim;
    View layout;
    View mainlayout;
    ...
    public fragmentKuis7(){}
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        fragmentLayout = inflater.inflate(R.layout.activity_fragment_kuis7,container,false);
        ...
        buttonk.add(btnC);
        buttonk.add(btnD);
        soalString = getResources().getStringArray(R.array.soal7);
        pilihan = getResources().getStringArray(R.array.pilihan7);
        jumlahpilhan = getResources().getIntArray(R.array.jumlahpilihan7);
        jawabankuis = getResources().getStringArray(R.array.penjelasanjawaban7);
        jawabanPiliihanKuis = getResources().getIntArray(R.array.jawabankuis7);
        ...
        soalSpecial =  fragmentLayout.findViewById(R.id.soalSpecial);
        soalSpecial.setVisibility(View.INVISIBLE);
...
//        pw.showAtLocation(mainlayout, Gravity.CENTER, 0, 0);
        ...
        soalDikerjakan = userData.getInt(getString(R.string.QUIZ_AKU_SOAL7),-1);
...
//        Memasukan Soal
            ...
            if(nomor == 2){
                final SpannableStringBuilder sb = new SpannableStringBuilder(soalString[nomor]);

                final StyleSpan bss = new StyleSpan(android.graphics.Typeface.BOLD); // Span to make text bold
                //final StyleSpan iss = new StyleSpan(android.graphics.Typeface.ITALIC); //Span to make text italic
                sb.setSpan(bss, 36, 44, Spannable.SPAN_INCLUSIVE_INCLUSIVE); // make first 4 characters Bold
                sb.setSpan(new UnderlineSpan(), 36, 44, 0);
                // make last 2 characters Italic
                soalSpecial.setVisibility(View.VISIBLE);
                soalSpecial.setText(sb);
            }
//        Memasukan rest
...
//        Jika jawaban benar maka Button akan berganti warna menjadi emas
        ...
        if(jawaban == jawabanBenar){
            ...
            pw.showAtLocation(fragmentLayout.findViewById(R.id.kuis7), Gravity.CENTER, 0, 0);
...
//        Jika salah maka yang benar di ganti warna, dan yang dipilih berganti warna menjadi abu2
    ...
    public void updateNilai(){
        ...
        editor.putInt(getString(R.string.QUIZ_AKU_SOAL7), soalDikerjakan);
