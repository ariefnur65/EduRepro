...
public class fragmentKuis8 extends Fragment implements View.OnClickListener {
    View fragmentLayout;
    Animation myAnim;
    View layout;
    View mainlayout;
    ...
    public fragmentKuis8(){}
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        fragmentLayout = inflater.inflate(R.layout.activity_fragment_kuis8,container,false);


//        Menentukan apakah ada gambar atau bukan
        ...
        btnE = fragmentLayout.findViewById(R.id.E);
        ...
        soalString = getResources().getStringArray(R.array.soal8);
        pilihan = getResources().getStringArray(R.array.pilihan8);
        jumlahpilhan = getResources().getIntArray(R.array.jumlahpilihan8);
        jawabankuis = getResources().getStringArray(R.array.penjelasanjawaban8);
        jawabanPiliihanKuis = getResources().getIntArray(R.array.jawabankuis8);
...
//        pw.showAtLocation(mainlayout, Gravity.CENTER, 0, 0);
        ...
        soalDikerjakan = userData.getInt(getString(R.string.QUIZ_AKU_SOAL8),-1);
            ...
            for(int i = 0 ; i < jumlahpilhan[nomor];i++){
                ...
                switch (jumlahpilhan[nomor]){
                    ...
                    case 3:
                        ...
                        buttonk.get(4).setEnabled(false);
                        buttonk.get(4).setAlpha(0f);
                        break;
                    case 4:
                        for (int t =0; t < buttonk.size();t++)
                        {
...
//        Jika jawaban benar maka Button akan berganti warna menjadi emas
        ...
        if(jawaban == jawabanBenar){
            ...
            pw.showAtLocation(fragmentLayout.findViewById(R.id.kuis8), Gravity.CENTER, 0, 0);
...
//        Jika salah maka yang benar di ganti warna, dan yang dipilih berganti warna menjadi abu2
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.D:
                ...
                break;
            case R.id.E:
                btnE.startAnimation(myAnim);
                checker(4,currentNumb);
    ...
    public void updateNilai(){
        ...
        editor.putInt(getString(R.string.QUIZ_AKU_SOAL8), soalDikerjakan);
